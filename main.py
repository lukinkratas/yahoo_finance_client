...
async def main() -> None:
    ...
    aapl_1y_chart = await client.get_chart(
        ticker='AAPL', period_range='ytd', interval='1d', events='div'
    )
    print(f'{aapl_1y_chart=}\n')

    msft_5d_chart = await client.get_chart(
        ticker='MSFT', period_range='5d', interval='1h', events='div,split'
    )
    print(f'{msft_5d_chart=}\n')
...
if __name__ == '__main__':
    ...
    # aapl_insights = await client.get_insights(ticker='AAPL')
    # print(f'{aapl_insights=}\n')
